...
```
crates/
└── import-extractor/         # Rust subprocess: TS import extraction
...
- **`crates/import-extractor`** — long-lived Rust subprocess that the gazelle plugin spawns for parsing. TypeScript via `oxc`. Length-prefixed protobuf wire protocol over stdin/stdout. See [`crates/import-extractor/README.md`](crates/import-extractor/README.md).
